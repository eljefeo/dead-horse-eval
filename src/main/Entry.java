...
public class Entry {
	 ...
	 public static void main (String[] args) throws java.lang.Exception
		...
		// EvalTestPlayground.randomizerSpeedTest5CardDiagnostics(50);
		 EvalTestPlayground.howLongUntilYouGetThisKindOfHands(7);
	...
	//	EvalTestPlayground.randomizerSpeedTest7Card(10000000); 
		...
		//EvalTestPlayground.randomizerSpeedTest7Card(30000000);
		 ...
		 //EvalTestPlayground.randomizerSpeedTest5Card(25000000); // speed average : 25000000 hands in 0.131336636 seconds = 190Mhps
		//EvalTestPlayground.randomizerSpeedTest5Card(130000000);
