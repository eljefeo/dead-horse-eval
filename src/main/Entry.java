...
public class Entry {
	...
	//	EvalTestPlayground.randomizerSpeedTest7Card(10000000); 
		...
		//EvalTestPlayground.randomizerSpeedTest7Card(30000000);
		 ...
		 //EvalTestPlayground.randomizerSpeedTest5Card(25000000); // speed average : 25000000 hands in 0.121995199 seconds = 204Mhps
		//EvalTestPlayground.randomizerSpeedTest5Card(130000000); // Did 130000000 hands in 0.6159191 seconds 211 million hands a second
