...
public class HandMaker {
	 ...
	 public static int[] makeLotsOfRandom5CardHands(int howMany){
	  ...
	  //They do not make completely random hands, but they are good enough for some testing I needed to do...
	  
	  
	  //there is an error in this method, it makes some cards as 0,  I did it quick and dirty. It needs re-doing
